...
NewClient="/portainer/Files/AppData/Config/Joal/config/clients/qbittorrent-$QBT_VERSION_2.client"
cp $BlankFile $NewClient && sed -i "s/-qB0000-/$peer_id_prefix/;s/0.0.0/$QBT_VERSION_2/" $NewClient
sed -i "s/utorrent-3.5.0_43916/qbittorrent-$QBT_VERSION_2/" /portainer/Files/AppData/Config/Joal/config/config.json
